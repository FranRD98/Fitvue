          ...
          <div class="relative dropdown">
            ...
            <div class="dropdown-menu bg-white shadow-lg mt-0 border-t border-gray-200">
              <div class="dropdown-content p-8">
                <h2 class="text-2xl font-bold text-cyan-800 mb-6">Conoce nuestras rutinas</h2>
                <div class="grid grid-cols-4 gap-8">
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link @click="dropdownOpen = false" to="/rutinas/entrenamiento" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Entrenamientos</router-link>
                  </div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link to="/rutinas/mindfulness" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Mindfulness</router-link>
                  </div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link to="/rutinas/estiramientos" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Estiramientos</router-link>
                  </div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link to="/rutinas/yoga" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Yoga</router-link>
                  </div>
              ...
              <div class="dropdown-content p-8">
                ...
                <div class="grid grid-cols-4 gap-8">
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link to="/nutricion/suplementacion" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Suplementación</router-link>
                  </div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <router-link to="/nutricion/recetas" class="nav-link text-md font-semibold text-gray-600 hover:text-cyan-8000">Recetas</router-link>
                  </div>
